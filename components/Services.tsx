...
export default function Services() {
  ...
  return (
    <div id="services">
      ...
      <div className="grid grid-cols-1 grid-rows-2 lg:grid-cols-2 lg:grid-rows-1  lg:gap-5 lg:ml-7 mb-36 ml-7">
        <div className="bg-white dark:bg-hover-dark  rounded-2xl p-2 hover:translate-x-1 hover:translate-y-1">
          <h4 className=" font-oswald font-normal text-lg mb-3">Google Ads</h4>
        ...
        <div className="bg-white dark:bg-hover-dark  rounded-2xl p-2 hover:translate-x-1 hover:translate-y-1 lg:mt-0 mt-7">
          <h4 className=" font-oswald font-normal text-lg mb-3">Software Developer</h4>
